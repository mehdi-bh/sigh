...
public final class RootScope extends Scope
{
    ...
    public final SyntheticDeclarationNode Any    = decl("Any",    TYPE);

//    public final SyntheticDeclarationNode Tuple  = decl("")
    ...
    public RootScope (RootNode node, Reactor reactor) {
        ...
        reactor.set(Any,    "type",       TypeType.INSTANCE);
        ...
        reactor.set(Any,    "declared",    AnyType.INSTANCE);
